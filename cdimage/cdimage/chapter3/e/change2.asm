...
.2:	; 显示完毕
	...
	push	0
	retf		; Ring0 -> Ring3，历史性转移！将打印 'Ring3'。
...
LABEL_SEG_CODE_DEST:
	...
	mov	edi, (80 * 13 + 0) * 2	; 屏幕第 12 行, 第 0 列。
	mov	ah, 0Ch			; 0000: 黑底    1100: 红字
	mov	al, 'G'
	mov	[gs:edi], ax

    mov	edi, (80 * 13 + 1) * 2	; 屏幕第 12 行, 第 0 列。
	mov	ah, 0Ch			; 0000: 黑底    1100: 红字
	mov	al, '1'
	mov	[gs:edi], ax
	...
	jmp	SelectorLDTCodeA:0	; 跳入局部任务，将打印 'Ring0'。
...
LABEL_CODE_A:
	...
	mov	edi, (80 * 14 + 0) * 2	; 屏幕第 13 行, 第 0 列。
	mov	ah, 0Ch			; 0000: 黑底    1100: 红字
	mov	al, 'L'
	mov	[gs:edi], ax
...
LABEL_CODE_RING3:
	...
	mov	edi, (80 * 12 + 0) * 2	; 屏幕第 14 行, 第 0 列。
	mov	ah, 0Ch			; 0000: 黑底    1100: 红字
	mov	al, 'R'
	mov	[gs:edi], ax

    mov	edi, (80 * 12 + 1) * 2	; 屏幕第 14 行, 第 0 列。
	mov	ah, 0Ch			; 0000: 黑底    1100: 红字
	mov	al, 'i'
	mov	[gs:edi], ax

    mov	edi, (80 * 12 + 2) * 2	; 屏幕第 14 行, 第 0 列。
	mov	ah, 0Ch			; 0000: 黑底    1100: 红字
	mov	al, 'n'
	mov	[gs:edi], ax
    
    mov	edi, (80 * 12 + 3) * 2	; 屏幕第 14 行, 第 0 列。
	mov	ah, 0Ch			; 0000: 黑底    1100: 红字
	mov	al, 'g'
	mov	[gs:edi], ax
    
    mov	edi, (80 * 12 + 4) * 2	; 屏幕第 14 行, 第 0 列。
	mov	ah, 0Ch			; 0000: 黑底    1100: 红字
	mov	al, '3'
	mov	[gs:edi], ax
