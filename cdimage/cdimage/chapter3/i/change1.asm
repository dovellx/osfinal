...
_szReturn			db	0Ah, 0
_KBoardInterrupt    db  "Now have a KBoardInterrupt", 0
; 变量
...
KBoardInterrupt equ _KBoardInterrupt -$$
...
.021h:		Gate	SelectorCode32,    KBoardHandler,      0, DA_386IGate
%rep 10
		Gate	SelectorCode32, SpuriousHandler,      0, DA_386IGate
%endrep
.02ch:		Gate	SelectorCode32,    MouseHandler,      0, DA_386IGate
%rep 83
		Gate	SelectorCode32, SpuriousHandler,      0, DA_386IGate
%endrep
...
Init8259A:
	...
	mov	al, 11101111b	; 屏蔽从8259除了鼠标中断外所有中断
...
_KBoardHandler:
KBoardHandler equ _KBoardHandler - $$
    ;inc byte [gs:((80 * 0 + 70) * 2 + 1)]
    push	KBoardInterrupt
	call	DispStr	
	add	esp, 4
    in al, 0x60
    mov al, 20h
